...
struct Neighbor {
    ...
    Neighbor() = default;
    Neighbor(unsigned id, float distance, bool f) : id{id}, distance{distance}, flag(f), hop_count(0) {}
    Neighbor(unsigned id, float distance, bool f, unsigned hc) : id{id}, distance{distance}, flag(f), hop_count(hc) {}
